        ...
        <div class="carousel-item active ">
            ...
            <div class="carousel-caption d-block   d-md-block">
                <div class="  ">
                    ...
                    <h6 class=" font-20 line-height-38 font-lg-20  line-height-lg-48 text-white" data-aos="fade-right"
            ...
            <div class="carousel-caption d-block  d-md-block">
                <div class="text-left">
                    <h1 class="font-30 font-lg-40  line-height-lg-48 line-height-38 text-white" data-aos="fade-right"
                        ...
                        <b><?php if ($_SESSION['lan'] == 'CN') echo '銀河遠東'; else echo 'Galaxy Far East Limited ' ?></b> <?php if ($_SESSION['lan'] == 'CN') echo '是一家領先的工程建設和國際商品貿易公司.'; else echo 'is a leading engineering construction and  international
                        commodity trading company. ' ?>
                    </h1>
                    <a href="#our_commodities"
                       class="btn btn-success custom-btn mt-2"><?php if ($_SESSION['lan'] == 'CN') echo '瞭解更多'; else echo ' Discover More' ?></a>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-block  d-md-block">
                <div class="text-left">
                    ...
                    <a href="#our_commodities" target="_blank"
                       class="btn btn-success custom-btn mt-2"><?php if ($_SESSION['lan'] == 'CN') echo '瞭解更多'; else echo ' Discover More' ?></a>
                </div>
            </div>
        </div>
...
<div class="choose1 sp4" id="about_us">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="hadding1">
                    ...
                    <div class="space8"></div>
                    <p style="text-align: justify;font-size: 24px" data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '銀河遠東成立於2018 年，從事工程建設和商品貿易。'; else echo '  <br>Galaxy Far East Limited </b> was established in 2018, engages in engineering construction and
                        commodity
                        trading.' ?></p>
                    <p style="text-align: justify;font-size: 24px;margin-top: 1em" data-aos="fade-right"
                       data-aos-duration="1200"><?php if ($_SESSION['lan'] == 'CN') echo '我們從事的行業歷史悠久，早在數千年前人類就開始了土木工程和易貨貿易。 '; else echo ' Our industry has a long history, humans began civil engineering and barter trade
                        thousands of years ago.' ?>
                    </p>
                    <p style="text-align: justify;font-size: 24px;margin-top: 1em" data-aos="fade-right"
                       data-aos-duration="1400"><?php if ($_SESSION['lan'] == 'CN') echo '如今，運用貿易技巧並借助全球網絡，我們履行著分銷及交付實物商品的重要經濟職能，以此平衡全球原材料的供需，滿足發達經濟體與新興經濟體的渴望和需求。'; else echo 'Based on trade techniques and global network, we perform the vital economic function of
                        distributing and
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-sm-6 col-4 text-center">
                    <div class="counter-hadding" data-aos="zoom-out" data-aos-duration="1000">
                        <p class="fs-6"
                           style="font-size: 29px !important;"><?php if ($_SESSION['lan'] == 'CN') echo '活躍 '; else echo 'Active' ?></p>
                ...
                <div class="col-md-6 col-sm-6 col-lg-4 text-center col-4">
                    <div class="counter-hadding" data-aos="zoom-out" data-aos-duration="1600">
                        <p class="fs-6"
                           style="font-size: 29px !important;"><?php if ($_SESSION['lan'] == 'CN') echo '服務'; else echo 'Service' ?></p>
                ...
                <div class="col-md-6 col-sm-6 col-lg-4 text-center col-4">
                    <div class="counter-hadding" data-aos="zoom-out" data-aos-duration="1400">
                        <p class="fs-6"
                           style="font-size: 29px !important;"><?php if ($_SESSION['lan'] == 'CN') echo '辦公 '; else echo 'Offices' ?></p>
        ...
        <div class="row align-items-center mt-3">
            ...
            <div class="col-lg-6 mt-4 order-lg-1 order-0">
                <div class="hadding1">
                    ...
                    <div class="space8"></div>
                    <p style="text-align: justify;font-size: 24px" data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '銀河遠東最顯著的優勢是遍布主要業務地點的員工網絡。通過在交易商品的主要地點開設辦公室，員工就當地市場情況提供的信息對確定我們的業務經營至關重要。 '; else echo 'Our most significant advantage is its employee network spread across major business locations.
                    ...
                    <p style="text-align: justify;font-size: 24px;margin-top: 1em" data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '辦公室網絡也為我們提供了最新的洞見和市場認知。當地的員工可幫助我們訂立新合同，加強與供應商和客戶的關係，從而提高公司的採購和分銷能力。 '; else echo ' The office network also supports us with the latest insights and market awareness. Local
                    ...
                    <p style="text-align: justify;font-size: 24px;margin-top: 1em" data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '我們嚴格執行“瞭解你的客戶”(KYC)程序並遵守對所有員工具有強制力的全面的“商業行為守則” '; else echo '  We strictly adhere to the \'Know Your Customer\' (KYC) procedure and adhere to a comprehensive and
        ...
        <div class="row  align-items-center mt-5  ">
            ...
            <div class="card  col-lg-2 col-12  mb-3 mr-2" style="  height: 600px;">
                ...
                <div class="card-body">
                    ...
                    <p style="text-align: justify"
                       class="card-text"><?php if ($_SESSION['lan'] == 'CN') echo '銀河遠東與印度領先的鹽礦合作，將優質的散裝原鹽發往中國，為中國氯鹼和純鹼化工企業提供質優價廉的生產原料，用於生產聚氯乙烯樹脂、燒鹼、純鹼等化工產品，並將這些化工產品推廣到南亞和中東市場； '; else echo 'Supported by leading Salt mines in India on
            ...
            <div class="card  col-lg-2 col-12 mb-3 mr-2" style="  height: 600px;">
                ...
                <div class="card-body">
                    ...
                    <p style="text-align: justify"
                       class="card-text"><?php if ($_SESSION['lan'] == 'CN') echo '銀河遠東提供中國的化工設備和生產技術，協助印度鹽礦建立化工廠，生產液體溴素和溴化學品，這些化學產品可以為當地的制藥行業和油田開採提供生產原料； '; else echo 'We support Indian Salt mines to set up chemical
            ...
            <div class="card  col-lg-2 col-12 mb-3 mr-2" style="  height: 600px;">
                ...
                <div class="card-body">
                    ...
                    <p style="text-align: justify"
                       class="card-text"><?php if ($_SESSION['lan'] == 'CN') echo '銀河遠東與中國鋼鐵廠的買家進行印度鐵礦石的大宗貿易，生產鋼鐵產品。我們還向中國當地合作夥伴採購和銷售鋼筋等結構鋼，用於房地產建設。 '; else echo 'We trade India Iron Ore in bulk with buyers for  Chinese steel works, to
            ...
            <div class="card  col-lg-2 col-12 mb-3 mr-2" style="  height: 600px;">
                ...
                <div class="card-body">
                    ...
                    <p style="text-align: justify"
                       class="card-text"><?php if ($_SESSION['lan'] == 'CN') echo '我們在中國大陸從事房地產工程建設，建設項目座落於安徽、湖北、江蘇等省份，年建築面積約2000萬平方英尺，年產值約人民幣25 億。 '; else echo 'We are engaged in real estate construction Industry
        ...
        <div class="row align-items-center pt-5" id="our_commodities">
            <div class="hadding1">
                ...
                <div class="col-lg-6 order-lg-1 order-0  mb-3">
                    <div class="hadding1">
                        ...
                        <p data-aos="fade-right"
                           data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '我們通過散貨船供應散裝印度海鹽發往中國，氯化鈉含量從94%到 99.5%，可滿足氯鹼和純鹼工業使用需求。'; else echo 'We trade Sea Salt in bulk for Chlor-Alkali &
                            Soda
            ...
            <div class="col-lg-6  mb-3">
                <div class="hadding1">
                    ...
                    <div class="space8"></div>
                    <p data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '我們通過散貨船供應印度鐵礦粉/球團發往中國，礦粉鐵含量從52%到65%'; else echo 'We trade Iron Ore Fine/Pellet in bulk for Steel Works with Fine Fe content from 52% to 65%
                        from
                        India to China.' ?>
        ...
        <div class="row align-items-center pt-5">
            ...
            <div class="col-lg-6 order-lg-1 order-0  mb-3">
                <div class="hadding1">
                    ...
                    <div class="space8"></div>
                    <p data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '我們交易中國產聚氯乙烯樹脂，產品源於乙烯法或者電石法生產工藝，K 值從 55 到 70，用於生產管材，型材，地板，電纜等產品。'; else echo 'We trade PVC Resin K value from 55-70 range from Ethylene basis or Carbide basis, for Pipe,
        ...
        <div class="row align-items-center pt-5">
            <div class="col-lg-6">
                <div class="hadding1">
                    ...
                    <div class="space8"></div>
                    <p data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '我們供應印度產溴素通過ISO儲罐運輸，以及溴化鈉和溴化鈣等化學品，可通過集裝箱船發往各主要海港。'; else echo 'We supply Liquid Bromine by ISO tank, NaBr and
        ...
        <div class="row align-items-center pt-5">
            ...
            <div class="col-lg-6 order-lg-1 order-0 mb-3">
                <div class="hadding1">
                    ...
                    <div class="space8"></div>
                    <p data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '我們採購和銷售建築鋼材，如螺紋鋼產品，用於中國的土木工程建設或者出口到其他國家。'; else echo 'We purchase and sell structural steel like Rebar, for local civil engineering construction
                        in
        ...
        <div class="row align-items-center pt-5">
            <div class="col-lg-6">
                <div class="hadding1">
                    ...
                    <div class="space8"></div>
                    <p data-aos="fade-right"
                       data-aos-duration="1000"><?php if ($_SESSION['lan'] == 'CN') echo '我們提供從鹵水中提取溴素的生產裝置及技術，幫助客戶設立工廠生產溴素及溴化物產品。'; else echo 'We supply Cold process Bromine Plant and
            ...
            <div class="col-lg-4 col-sm-6 hadding1 mt-4 ">
                <div class="single-footer-contact single-footer">
                    ...
                    <div class="padding-left20">
                        <div class="">
                            <p><?php if ($_SESSION['lan'] == 'CN') echo '地址：'; else echo ' Address:' ?>
                                <br><?php if ($_SESSION['lan'] == 'CN') echo '香港油麻地彌敦道 498-500 號泰盛商業大廈 5/F'; else echo ' 5/F TAI SHING COMMERCIAL BUILDING, 498-500 NATHAN
                                ROAD, KOWLOON,
                                HONGKONG' ?></p>
                        </div>
